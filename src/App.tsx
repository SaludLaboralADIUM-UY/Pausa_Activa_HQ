...
export default function App() {
  ...
  return (
    <div id="active-break-root" className="min-h-screen bg-warm-canvas font-sans text-[#2f2e27] flex flex-col justify-between selection:bg-[#30475c]/20 overflow-x-hidden">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-14 py-8 flex flex-col justify-center items-center relative">
        ...
        <div id="mode-selector" className="w-full max-w-3xl mb-6">
          <div className="flex items-center gap-2 bg-[#eadecf]/50 p-2 rounded-[20px] border border-[#d5d2c8]">
            <button
              onClick={goBodyMode}
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-2xl text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 ${
                screenMode === 'body'
                  ? 'bg-[#30475c] text-white shadow-md'
                  : 'text-[#6b6960] hover:bg-white/60'
              }`}
            >
        ...
        {screenMode === 'eyes' && (
          <div id="eye-panel" className="w-full max-w-3xl flex flex-col items-center">
            ...
            <div className="w-full bg-[#faf8f4] border-l-4 border-[#1f7d96] p-6 rounded-r-[24px] shadow-xs mb-6">
              <h4 className="text-xs uppercase font-extrabold tracking-widest text-[#1f7d96] mb-2">¿Qué debe hacer ahora?</h4>
              <p className="text-xl font-bold text-[#222222] leading-relaxed">
            ...
            <div className="w-full bg-white rounded-[32px] border border-[#d5d2c8] shadow-sm p-6 sm:p-10 flex flex-col items-center">
                ...
                return (
                  <div className="relative w-[300px] h-[300px] sm:w-[340px] sm:h-[340px] flex items-center justify-center">
                    <svg className="w-full h-full transform -rotate-90" viewBox="0 0 300 300">
                      <circle cx="150" cy="150" r={R} stroke="#e7eef0" strokeWidth="20" fill="transparent" />
                      <circle
                        cx="150" cy="150" r={R}
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-[7rem] sm:text-[8rem] font-display font-extrabold text-[#16222b] font-mono leading-none tabular-nums">
                        {displayNum}
                      </span>
                      <span className="text-sm font-bold text-[#5f7a83] uppercase tracking-[0.3em] mt-1">Segundos</span>
                    </div>
                  </div>
                );
              })()}
              ...
              <div className="mt-7 flex flex-col items-center gap-3">
                ...
                {eyeStep === 1 && (
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider text-[#5f7a83] hover:bg-[#eef3f4] transition-all duration-300"
                  >
                ...
                {/* Done message */}
                {eyeStep === 3 && (
                  <p className="text-center text-base text-[#4d4c45] max-w-md mt-1 leading-relaxed">
            ...
            <div className="w-full mt-8 space-y-6">
              <div className="px-2">
                <h4 className="text-xs uppercase font-bold tracking-widest text-[#716f67] mb-2">¿Por qué sirve este ejercicio? (Regla médica 20/20/20)</h4>
                <p className="text-base text-[#4d4c45] font-light leading-relaxed">
              ...
              <div className="px-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="bg-white border border-[#e2ddd5] rounded-2xl p-4">
                    ...
                    <p className="text-xs text-[#5e5c54] leading-relaxed">Combina el brillo del monitor con la luminosidad del cuarto para evitar contrastes agresivos.</p>
                  </div>
                  <div className="bg-white border border-[#e2ddd5] rounded-2xl p-4">
                    <h5 className="text-[11px] font-bold uppercase tracking-wider text-[#30475c] mb-1.5">Distancia de trabajo</h5>
                    <p className="text-xs text-[#5e5c54] leading-relaxed">Coloca la pantalla a 50-60 cm de distancia de tu cara (el largo de tu brazo).</p>
                  </div>
                  <div className="bg-white border border-[#e2ddd5] rounded-2xl p-4">
                    <h5 className="text-[11px] font-bold uppercase tracking-wider text-[#30475c] mb-1.5">Lubricación natural</h5>
                    <p className="text-xs text-[#5e5c54] leading-relaxed">Ante pantallas parpadeamos un 70% menos. Haz pausas deliberadas para parpadear consciente.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {screenMode === 'body' && sequenceFinished && (
          <div id="closing-screen" className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-12 xl:col-span-7 flex flex-col justify-center space-y-6">
              ...
              {/* Recommendation card */}
              <div className="bg-white p-6 sm:p-8 rounded-[28px] border border-[#d5d2c8] shadow-sm space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-display font-bold text-lg text-[#222222] leading-tight">Una recomendación más</h4>
                    <p className="text-xs text-[#716f67]">Recomendación de Salud Ocupacional ADIUM</p>
                  </div>
                </div>
                ...
                <div className="border-t border-[#f0ece3] pt-5 space-y-3">
                  ...
                  <p className="text-sm text-[#6b6a62] font-light leading-relaxed">
        ...
        <div id="routine-tabs" className="w-full mb-8">
          <div className="flex items-center gap-3 bg-[#eadecf]/50 p-2.5 rounded-[24px] border border-[#d5d2c8]">
            {/* Arrow only — previous */}
            <button
              onClick={handlePrevRoutine}
              className="shrink-0 flex items-center justify-center w-10 h-10 rounded-full bg-white/80 hover:bg-white text-[#30475c] border border-[#d3d0c9] shadow-sm hover:scale-105 transition-all duration-200"
              title="Anterior"
            >
                ...
                return (
                  <button
                    ...
                    className={`px-3 py-2 rounded-xl text-[11px] font-bold uppercase tracking-wider leading-tight text-center transition-all duration-300 ${
                      isActive
                        ? 'bg-[#30475c] text-white shadow-md'
                        : 'bg-white/80 hover:bg-white text-[#525048] border border-[#d3d0c9]'
                    }`}
                  >
                    {routine.name}
                  </button>
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-12 xl:col-span-5 flex flex-col items-center justify-center">
            ...
            <div className="mb-4 text-center">
              ...
              <div className="mt-1 flex flex-wrap items-center justify-center gap-2 text-xl font-display font-extrabold text-[#2c2b25]">
                <span className="bg-[#4a92a8]/10 text-[#30475c] py-0.5 px-3 rounded-lg border border-[#4a92a8]/20 font-mono text-sm uppercase">
            ...
            <div id="posture-card-frame" className="relative bg-white p-4.5 rounded-[36px] border border-[#d3d0c9] shadow-xl w-full max-w-[340px] sm:max-w-[360px] md:max-w-[380px] lg:max-w-[390px] overflow-hidden">
          ...
          <div className="lg:col-span-12 xl:col-span-7 flex flex-col justify-center space-y-8">
            ...
            <div id="step-title-block" className="space-y-2">
              <h2 className="font-display font-extrabold text-3xl sm:text-5xl text-[#222222] tracking-tight leading-tight">
                {currentRoutine.name}
              </h2>
            </div>

            {/* MAIN COUNTER & TIMER CIRCLE COMBINED BAR */}
            <div id="countdown-card" className="bg-white p-6 sm:p-8 rounded-[32px] border border-[#d5d2c8] shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6 relative overflow-hidden">
              <div className="flex-1 space-y-1">
                <span className="text-xs font-bold text-[#30475c] uppercase tracking-wider block">
                ...
                <p className="text-2xl font-display font-bold text-[#222222]">
                ...
                <div className="flex items-center gap-2 text-xs font-semibold text-[#30475c] mt-1">
                  <span>Recomendación médica de pausa:</span>
                  <span className="bg-[#30475c]/12 py-0.5 px-2.5 rounded-full font-bold">{currentStepData.duration} total</span>
                </div>

                {/* VISUAL PLAY PAUSE INTERACTIVE CONTROLS */}
                <div className="flex flex-wrap items-center gap-2.5 pt-3.5 border-t border-[#f0ece3] mt-3.5">
                  <button
                    id="btn-toggle-play"
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-300 border ${
                      isPlaying 
                        ? 'bg-[#efebe4] hover:bg-[#e4dfd6] text-[#222222] border-[#dfdacd]' 
                        : 'bg-[#30475c] hover:bg-[#223342] text-white border-transparent shadow-[#30475c]/20 shadow-md'
                    }`}
                  >
                    {isPlaying ? (
                      <>
                        <Pause className="w-3.5 h-3.5 fill-[#222222] text-current" />
              ...
              <div id="progress-timer-circle" className="relative w-28 h-28 shrink-0 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-3xl font-display font-extrabold text-[#222222] font-mono leading-none">
                    {secondsRemaining}
                  </span>
                  <span className="text-[9px] font-bold text-[#706e68] uppercase tracking-wider mt-1">
                    SEGUNDOS
                  </span>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div id="action-instruction-block" className="bg-[#faf8f4] border-l-4 border-[#30475c] p-6 rounded-r-[24px] shadow-xs">
                <h4 className="text-xs uppercase font-extrabold tracking-widest text-[#30475c] mb-2">
              ...
              <div className="px-2">
                <h4 className="text-xs uppercase font-bold tracking-widest text-[#716f67] mb-2">
            ...
            <div id="timeline-block" className="pt-4">
              <h4 className="text-xs font-bold tracking-wider text-[#716f67] uppercase mb-3">SECUENCIA DE MOVIMIENTO ({currentRoutine.name})</h4>
                  ...
                  return (
                    <button 
                      ...
                      className={`p-3 rounded-2xl border text-center transition-all duration-300 text-left ${
                        isActive 
                          ? 'bg-[#30475c] border-[#30475c] text-white shadow-md' 
                          : isPast 
                            ? 'bg-[#faf8f5]/60 border-[#dfdacd]/70 text-[#9c9a92]' 
                            : 'bg-white border-[#e2ddd5] text-[#2f2e27] hover:bg-white/90'
                      }`}
                    >
